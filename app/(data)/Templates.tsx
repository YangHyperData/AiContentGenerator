export default  [
    ...
    },
    {
        ...
        icon: 'https://cdn-icons-png.flaticon.com/128/3938/3938055.png',
        slug: 'tiktok-seo-title',
        aiPrompt: 'Give me some best tiktok content for some topics I gave',
        form: [
            {
                label: 'Enter your tiktok video topic keywords',
                field: 'input',
                name: 'keywords',
                required:true
            },
            {
                label: 'Enter tiktok description Outline here',
                field: 'textarea',
                name: 'outline'
            }
        ]
    ...
    },
    {
        ...
        icon: 'https://cdn-icons-png.flaticon.com/128/620/620765.png',
        slug: 'travel-content',
        aiPrompt: 'Give me some best travel plan when I gave location',
        form: [
            {
                label: 'Enter your travel place keywords',
                field: 'input',
                name: 'keywords',
                required:true
            },
            {
                label: 'Enter travel description Outline here',
                field: 'textarea',
                name: 'outline'
            }
        ]
